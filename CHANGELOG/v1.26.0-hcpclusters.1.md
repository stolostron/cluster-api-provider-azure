...
- **ARO-HCP Support**: Comprehensive ARO Hosted Control Plane support using Azure Service Operator
  ...
  - Support for `v1api20251223preview` and `v1api20260901preview` API versions
  - Bump ARO-HCP API: remove `2024-*-preview`, add `2026-09-01-preview`
...
ASO version: v2.18+
ARM API versions: 2025-12-23-preview, 2026-09-01-preview
