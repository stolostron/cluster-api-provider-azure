...
func (in *AROAADProfile) DeepCopyInto(out *AROAADProfile) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AROAADProfile.
func (in *AROAADProfile) DeepCopy() *AROAADProfile {
	if in == nil {
		return nil
	}
	out := new(AROAADProfile)
	in.DeepCopyInto(out)
	return out
}
